function markdown_link_wrap()
    ...
    -- Replace the text
    vim.api.nvim_buf_set_text(0, current_line_number-1, start_col - 1, current_line_number -1, end_col, {'[' .. selected_text .. '][]'})
...
vim.api.nvim_set_keymap('v', '<leader>em', '<cmd>lua markdown_link_wrap()<cr>', { noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<leader>el', '<cmd>lua yank_replace_url()<cr>', { noremap = true, silent = true})
